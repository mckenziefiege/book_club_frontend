      ...
      <div>
        ...
        <div className="eventPageContainer">
          <div className="eventPagecol1">
            ...
            <p><i className="far fa-calendar-alt"></i>  {this.props.club.date}</p>
            <p><i className="far fa-clock"></i>  {this.props.club.time}</p>
            <p><i className="fas fa-map-marker-alt"></i>  {this.props.club.address}, {this.props.club.city}, {this.props.club.state}, {this.props.club.zipcode}</p>
